...
function _aws_cdk_aws_stepfunctions_tasks_RunLambdaTaskProps(p) {
    ...
    if ("qualifier" in p)
        print("@aws-cdk/aws-stepfunctions-tasks.RunLambdaTaskProps#qualifier", "Use `LambdaInvoke`");
    visitedObjects.delete(p);
}
